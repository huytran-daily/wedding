...
function FrontCover({ onClickCenterBanner }: FrontCoverProps) {
  return (
    <div className="relative flex h-full flex-col items-center justify-between overflow-hidden bg-[#F5E1DA] py-10">
      ...
      <div
        className="bg-background-wedding-secondary absolute top-1/2 z-10 flex h-1/5 w-full -translate-y-1/2 items-center justify-center shadow-[0px_4px_16px_2px_#3D2C2C] cursor-pointer"
...
function InsidePage() {
  return (
    <div className="flex h-full">
      ...
      <div className="relative flex flex-1 flex-col items-center justify-between gap-3 px-5 pb-10 pt-10 bg-[#F5E1DA]">
        <div>
          ...
          <div className="flex w-full flex-col items-center justify-center text-center">
            <div className="text-text-wedding-primary relative flex h-[80px] w-[80px] items-center justify-center gap-0.5 leading-none">
              <span className="text-text-wedding-red absolute left-3 top-[10px] font-times text-4xl font-medium">
                H
              </span>
              <AndIcon 
                width="20" 
              ...
              />
              <span className="text-text-wedding-red absolute bottom-[10px] right-4 font-times text-4xl font-medium">
                T
              </span>
            </div>
          </div>
